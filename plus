<?php
/*Ushbu kod: zeroblogger (https://t.me/zero_blogger) tomonidan taxrirlangan. Iltimos, mualliflik huquqi hurmat qilinsin!*/
ob_start();
define("uzfox","1238662481:AAG9OMRgMnwAw2nBq9ILBfOU08J60-IeRWY");
$admin = "1051476700";
$botname = "MilliorderBolBot";
...
"inline_keyboard"=>[
[["text"=>"1-kana","url"=>"t.me/XBET_ANIQHISOB_uz"],],
[["text"=>"2-kanal","url"=>"t.me/UZXBET_Uzb"],],
[["text"=>"3-kanal","url"=>"https://t.me/Ekspreslar_uzb"],],
...
"thumb_url"=>"https://ActiveMember.000webhostapp.com/pul.jpg",
...
uzfox("sendMessage",[
"chat_id"=>$chat_id,
"text"=>"<b>Hurmatli foydalanuvchi!</b>\n<b>Siz admin tamonidan ban olgansiz. Shuning uchun botni ishlata olmaysiz!</b>",
"parse_mode"=>"html",
"reply_markup"=>json_encode([
"inline_keyboard"=>[
[["text"=>"📃 Batafsil maʼlumot","callback_data"=>"sabab"],],
